...
var recsofar = 1,
  batches = 0,
  batchsize = 1;
var statement ='CREATE (n:Ingredient {props}) RETURN n; '
//var statement = 'CREATE (r:Recipe {props}) RETURN n; '
//var statement = 'CREATE (n:Flavor {props}) RETURN n; '
...
var flavorsCreate =function(ing){
db.beginTransaction({
  statements:[{
    statement : 'CREATE (n:Flavor {props}) RETURN n; ',
      parameters : {
        props : {'flavorName':ing[0]}
      }
    }]
  },nextbatch );
}
...
//var ing = createFlavorArray().flavorNames;
